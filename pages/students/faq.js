...
To apply to HackCampus simply fill out [the application form](${facts.studentApplicationUrl}). Apart from basic information (contact details, university, etc.), you will have to upload your CV. We will ask you some technical questions, as well as the languages/technologies that you are comfortable working with. We will also ask you about the personal project(s) you have worked on that you are most proud of. From experience, this is the most important question for finding the right candidates. The best answers to this question contain links to code you have written yourself, as well as your motivations for completing this project and what you learnt from it.

## What's the deadline?

If you apply by the ${facts.studentApplicationDeadline}, you will be guaranteed to be included in the main batch of interviews. You will still be able to apply afterwards, but many of the places in the programme may already be taken.
...
[Apply here](${facts.studentApplicationUrl}) to take on interns in the programme.
`
